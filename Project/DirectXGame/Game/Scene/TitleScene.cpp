...
void TitleScene::Initialize() {
	...
	ParticleManager::GetInstance()->CreateParticleGroup("qr", "Resources/Textures/qrcord.png");

	title_ = std::make_unique<Object3DInstance>();
	title_->Initialize(object3DManager_, dxCore_, "Resources/Models/Title", "title.obj", "title");
	title_->SetTranslate({ 0.0f, 6.0f, 0.0f });
	title_->SetRotate({ 3.14f/2.0f,3.14f,0.0f });

	space_ = std::make_unique<Object3DInstance>();
	space_->Initialize(object3DManager_, dxCore_, "Resources/Models/Space", "space.obj", "space");
