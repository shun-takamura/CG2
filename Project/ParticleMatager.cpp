#include "ParticleMatager.h"

IDxcBlob* ParticleMatager::CompileShader(const std::wstring& filePath, const wchar_t* profile, IDxcUtils* dxcUtils, IDxcCompiler3* dxcCompiler, IDxcIncludeHandler* includeHandler)
{
    //=========================
   // 1.hlslファイルを読み込む
   //=========================
...
void ParticleMatager::Initialize(DirectXCore* dxCore, IDxcUtils* dxcUtils, IDxcCompiler3* dxcCompiler, IDxcIncludeHandler* includeHandler)
{
    dxCore_ = dxCore;
    dxcUtils_ = dxcUtils;
...
void ParticleMatager::CommonDrawSetting()
{
...
void ParticleMatager::CreateRootSignature()
{
    ...
    // ============================================
    // [0] VS: SRV (t0)  ← Instancing
    // ============================================
    D3D12_DESCRIPTOR_RANGE vsSrvRange{};
    vsSrvRange.RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
    vsSrvRange.BaseShaderRegister = 0;   // t0
    vsSrvRange.NumDescriptors = 1;
    vsSrvRange.OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND;

    params[0].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;
    params[0].ShaderVisibility = D3D12_SHADER_VISIBILITY_VERTEX;
    params[0].DescriptorTable.pDescriptorRanges = &vsSrvRange;
    ...
    psSrvRange.BaseShaderRegister = 0;   // t0
    ...
    params[3].DescriptorTable.pDescriptorRanges = &psSrvRange;
...
void ParticleMatager::CreateAllPipelineStates()
{
...
Microsoft::WRL::ComPtr<ID3D12PipelineState> ParticleMatager::CreateGraphicsPipelineState(BlendMode mode)
{
    CreateRootSignature();
